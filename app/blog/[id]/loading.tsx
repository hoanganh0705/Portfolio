  ...
  return (
    <div className='min-h-screen'>
      <div className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        ...
        <div className='h-10 w-32 bg-white/10 rounded-lg mb-8 animate-pulse' />
        ...
        <article>
          ...
          <div className='mb-8'>
            ...
            <div className='h-4 w-1/2 bg-white/10 rounded animate-pulse mb-6' />
          ...
          {/* Hero image skeleton */}
          <div className='h-96 bg-white/10 rounded-lg mb-8 animate-pulse' />
