...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://anhnguyendev.me/}{\Large Nguy\~{\^e}n Ho\`ang Anh}} & Email: \href{mailto:anh487303@gmail.com}{anh487303@gmail.com}\\
  \href{https://anhnguyendev.me/}{anhnguyendev.me} & Mobile: \href{tel:+84985335735}{+84-985-335-735} \\
\end{tabular*}
...
\resumeProjectHeading
  ...
  {Aug 2025 -- Feb 2026}
  {\href{https://anhnguyendev.me}{Live} \;|\; \href{https://github.com/your-repo}{GitHub}}
  \resumeItemListStart
    \resumeItemPlain{Architected a bilingual (EN/VI) portfolio and MDX blog using Next.js 16 App Router with Server Components, internationalization, and Incremental Static Regeneration (ISR).}
    \resumeItemPlain{Built a production-ready contact pipeline using Next.js Server Actions with Zod validation, honeypot bot detection, configurable rate limiting, parallel email delivery, and non-blocking logging.}
    \resumeItemPlain{Implemented a comprehensive SEO pipeline including dynamic metadata, sitemap, RSS feed, Open Graph images, JSON-LD structured data, and hreflang support for bilingual content.}
    \resumeItemPlain{Optimized frontend performance using dynamic imports, LazyMotion, server-side syntax highlighting, and content-visibility to reduce client-side JavaScript and improve initial page rendering.}
  \resumeItemListEnd

\resumeProjectHeading
  {Amazing Project 2}{Feb 2016 -- May 2017}{}
  \resumeItemListStart
    \resumeItemPlain{Began a group to create the first 36 hour student-run hackathon}
    \resumeItemPlain{Led 50 staff to raise \$175,000 and managed relationships with sponsors}
  \resumeItemListEnd

\resumeProjectHeading
  {Amazing Project 3}{Jan 2015 -- May 2015}{}
  \resumeItemListStart
    \resumeItemPlain{Assist in recruiting potential students to the CS program}
    \resumeItemPlain{Attend info sessions and student Q\&A events}
  \resumeItemListEnd
...
\section{Skills}
\resumeItemListStart
  \resumeItemPlain{\textbf{Languages:} JavaScript, Golang}
  \resumeItemPlain{\textbf{Frontend:} React, Nextjs}
  \resumeItemPlain{\textbf{Backend:} Node.js (Express, NestJS), Gin}
  \resumeItemPlain{\textbf{Databases:} PostgreSQL, MySQL, Redis}
  \resumeItemPlain{\textbf{Tools:} Git, Docker, Linux, Kubernetes, Github Actions}
\resumeItemListEnd
