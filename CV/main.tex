...
\resumeProjectHeading
  ...
  \resumeItemListStart
    \resumeItemPlain{Built a portfolio and blog platform using Next.js (App Router) and TypeScript with server-side rendering}
    \resumeItemPlain{Implemented i18n and MDX-based blog system with SEO, RSS, and dynamic routing}
    \resumeItemPlain{Designed modular architecture and integrated contact system with email automation and rate limiting}
  \resumeItemListEnd
