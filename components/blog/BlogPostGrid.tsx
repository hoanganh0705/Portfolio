    ...
    <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
      {posts.map((post) => (
        <Link
          ...
          className='group'
        >
          <div className='h-full flex flex-col rounded-xl border border-white/10 bg-white/5 p-6 transition-all duration-300 hover:border-accent-default/50 hover:bg-accent-default/5 hover:shadow-lg hover:shadow-accent-default/5'>
            <div className='pb-3'>
            ...
            <div className='flex-1 pb-4'>
              <h3 className='text-lg font-bold text-white mb-2 transition-colors group-hover:text-accent-default line-clamp-2'>
                {post.title}
              </h3>
